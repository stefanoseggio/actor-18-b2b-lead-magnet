...
function stableSeedRecordId(name: string, website: string | null): string {
 ...
 */
export function computeRecordId(discoverySource: 'seedList' | 'osm', nativeId: string | null, name: string, website: string | null): string {
