const DOMAIN_OR_URL_PATTERN = /^(https?:\/\/)?[a-z0-9](?:[a-z0-9-]*[a-z0-9])?(?:\.[a-z0-9](?:[a-z0-9-]*[a-z0-9])?)+(?:[/?#].*)?$/i;
function looksLikeDomainOrUrl(entry) {
...
function deriveNameFromDomain(entry) {
 ...
 */
export function parseSeedList(seeds) {
    const seen = new Set();
    const candidates = [];
